...
#include "D:\FirmwareEmbedded\Custom\Inc\delay.h"
#include "D:\FirmwareEmbedded\Custom\Inc\clock.h"
#include "D:\FirmwareEmbedded\Custom\Inc\capture.h"
#include "D:\FirmwareEmbedded\Custom\Inc\Usart.h"
#include "D:\FirmwareEmbedded\Custom\Inc\ADC.h"
#include "D:\FirmwareEmbedded\FreeRTOS-LTS\FreeRTOS\FreeRTOS-Kernel\include\FreeRTOS.h"
#include "D:\FirmwareEmbedded\FreeRTOS-LTS\FreeRTOS\FreeRTOS-Kernel\include\task.h"
#include"D:\FirmwareEmbedded\FreeRTOS-LTS/FreeRTOS/FreeRTOS-Kernel/include/FreeRTOS.h"
#include<D:\FirmwareEmbedded\FreeRTOS-LTS/FreeRTOS/FreeRTOS-Kernel/include/task.h>
#include<D:\FirmwareEmbedded\FreeRTOS-LTS/FreeRTOS/FreeRTOS-Kernel/portable/GCC/ARM_CM4F/portmacro.h>
#include<D:\FirmwareEmbedded\FreeRTOS-LTS/FreeRTOS/FreeRTOS-Kernel/include/queue.h>
#include<D:\FirmwareEmbedded\FreeRTOS-LTS/FreeRTOS/FreeRTOS-Kernel/include/event_groups.h>
#include<D:\FirmwareEmbedded\FreeRTOS-LTS/FreeRTOS/FreeRTOS-Kernel/include/semphr.h>
...
void func_5(void * param){
	...
	{
		xSemaphoreTake(uart_lock, 0xffffffff);
		usart_printf("\033[0;31m [Taks 5]\033[0m FINAL PROJECT \r\n");
		xSemaphoreGive(uart_lock);
		vTaskDelay(2000);
	}
